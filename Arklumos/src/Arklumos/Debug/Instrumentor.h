...
// Check this problem with __FUNCSIG__ #define AK_PROFILE_FUNCTION() AK_PROFILE_SCOPE(__FUNCSIG__)
#define AK_PROFILE_FUNCTION() AK_PROFILE_SCOPE(__PRETTY_FUNCTION__)
#else
