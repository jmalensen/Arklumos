...
{
	m_VertexArray = Arklumos::VertexArray::Create();
	...
	m_ArklumosLogoTexture = Arklumos::Texture2D::Create("assets/textures/ArkulumosLogo.png");
...
void ExampleLayer::OnUpdate(Arklumos::Timestep ts)
{
	// Update
	...
	Arklumos::Renderer::BeginScene(m_CameraController.GetCamera());
...
void ExampleLayer::OnEvent(Arklumos::Event &e)
{
