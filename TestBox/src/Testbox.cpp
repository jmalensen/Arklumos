...
public:
			...
			: Layer("Example"), m_Camera(-1.6f, 1.6f, -0.9f, 0.9f), m_CameraPosition(0.0f)
	{
		...
		m_Shader = Arklumos::Shader::Create("VertexPosColor", vertexSrc, fragmentSrc);
		...
		m_FlatColorShader = Arklumos::Shader::Create("FlatColor", flatColorShaderVertexSrc, flatColorShaderFragmentSrc);
	...
	void OnUpdate(Arklumos::Timestep ts) override
	{
		...
		m_Texture->Bind();
		Arklumos::Renderer::Submit(textureShader, m_SquareVA, glm::scale(glm::mat4(1.0f), glm::vec3(1.5f)));

		m_ArklumosLogoTexture->Bind();
		Arklumos::Renderer::Submit(textureShader, m_SquareVA, glm::scale(glm::mat4(1.0f), glm::vec3(1.5f)));
